...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://fz6r26l5ua.execute-api.us-east-1.amazonaws.com/test';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'Content-Type', 'x-amz-meta-customLabels', 'x-api-key'], ['body']);
